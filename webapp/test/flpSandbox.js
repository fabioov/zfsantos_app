		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#moovizfsantosapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"moovizfsantosapp-display": {
								"semanticObject": "moovizfsantosapp",
								"action": "display",
								"description": "List Details Fiori Freestyle",
								"title": "Companhias Aéreas",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=moovi.zfsantosapp",
									"url": sap.ui.require.toUrl("moovi/zfsantosapp")
								}
							}
						}
					}

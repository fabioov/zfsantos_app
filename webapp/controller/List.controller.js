sap.ui.define(
  ...
  function (
    ...
    return BaseController.extend("moovi.zfsantosapp.controller.List", {
      formatter: formatter,
      ...
      onOpenViewSettings: function (oEvent) {
        ...
        if (!this.byId("viewSettingsDialog")) {
          Fragment.load({
            ...
            name: "moovi.zfsantosapp.view.ViewSettingsDialog",
            controller: this,
          }).then(
            function (oDialog) {
      ...
      onBtnCreatePress: function (oEvent) {
        ...
        if (!this.oDialogEditCompany) {
          this.oDialogEditCompany = Fragment.load({
            id: this.getView().getId(),
            name: "moovi.zfsantosapp.view.EditCompanyDialog",
            controller: this,
          }).then(
            function (oDialog) {
              // connect dialog to the root view of this component (models, lifecycle)
